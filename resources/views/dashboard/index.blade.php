        ...
        <div class="main-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item active">Welcome to Value Wireless</li>
                                </ol>
                            </div>
                            <div class="col-md-4">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            © <script>document.write(new Date().getFullYear())</script> All Reserved by Value Wireless.</span>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                ...
                <div class="form-check form-switch mb-3">
                    <input type="checkbox" class="form-check-input theme-choice" id="dark-mode-switch" data-bsStyle="/css/bootstrap-dark.min.css"
