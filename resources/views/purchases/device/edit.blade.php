                ...
                <div class="col-lg-4 col-12 bg-white p-4">
                  <form class="form-group batch-form" id="batchForm" name="batchForm" action=""  method="post">
                    <div class="form-group">
                      ...
                      <input type="text" name="batch_no"  class="form-control" id="batch_no" value="Iphone 11 Black">
                      <p></p>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-info text-white" type="submit" name="" >Updated</button>
                    </div>
                  </form>
                </div> <!-- end row -->
              </div> <!-- container-fluid -->
